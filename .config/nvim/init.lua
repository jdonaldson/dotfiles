...
vim.api.nvim_set_keymap('n', '<leader>th', [[<cmd>lua require('telescope.builtin').oldfiles()<CR>]], { noremap = true, silent = true })


--Add config leader shortcuts
vim.api.nvim_set_keymap('n', '<leader>ev', [[:edit ~/.config/nvim/init.lua<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>sv', [[:source ~/.config/nvim/init.lua<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>ep', [[:edit ~/.config/nvim/lua/plugins.lua<CR>]], { noremap = true, silent = true })
